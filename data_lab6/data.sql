CREATE TABLE `projectbigquery0.causes_delay.us_delay_causes` (
  flight_date DATE,
  carrier STRING,
  delay_cause STRING,
  num_delays INT64
);
INSERT INTO `projectbigquery0.causes_delay.us_delay_causes` (flight_date, carrier, delay_cause, num_delays)
VALUES
